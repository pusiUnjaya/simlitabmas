...
Class MSubmit extends CI_Model
{
	...
	{
		$data = array();
		$this->db->select("dosen.id_dosen, dosen.nidn, dosen.namalengkap,peran.tugas, peran.jenis_anggota");
		$this->db->from("peran");
	...
	{
		$data = array();
		$this->db->select("allmhs.npm, allmhs.namamhs,peran.tugas, peran.jenis_anggota");
		$this->db->from("peran");
