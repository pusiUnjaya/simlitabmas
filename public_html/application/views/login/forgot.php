...
<head>
  ...
  <title>LPPM - Lupa Password</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">Silakan isikan alamat email anda kemudian akan kami kirimkan link untuk reset password anda!</p>
                  </div>
                  <form class="user" autocomplete="off">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Isikan Alamat Email Anda...">
                    </div>
