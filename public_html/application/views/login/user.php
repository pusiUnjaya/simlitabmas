            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
					...
					<?php
						if($this->session->flashdata('result') != '') 
							...
							echo '<p class="login-box-msg">Silakan Login</p>';
					?>
					</h1>
                  </div>
                  <form class="user" action="<?php echo base_url(); ?>login/cek" method="post">
                    <div class="form-group">
                      <input type="email" name="email" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Masukkan Alamat Email..." required autofocus>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url(); ?>lupa">Lupa Password?</a>
                  </div>
                  <div class="text-center">
