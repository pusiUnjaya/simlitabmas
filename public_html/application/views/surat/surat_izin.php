...
function indo_date($date)
{
    ...
    $ms = [1 => 'Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni',
...
<html>
    ...
    <body>
        <img style="margin-top:-20px" width="100%" src="<?php echo base_url('assets/img/kop.png') ?>">
        <div class="main">
            <table width="100%">
                <tr>
                    <td>Nomor</td><td> : </td><td><?php echo $nomor ?></td>
                    <td></td><td align="right">Yogyakarta, <?php echo indo_date($tanggal) ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Perihal</td><td> : </td><td>Izin <?php echo $jenis ?></td>
                    <td></td><td>Kepada</td>
                </tr>
                <tr>
                    <td></td><td></td><td></td>
                    <td align="right" valign="top">Yth. </td><td><?php echo nl2br($tertuju) ?><br>di<br><?php echo $tempat ?></td>
                </tr>
            </table>
            <p>Dengan hormat,</p>
            ...
            <table>
                <tr>
                    <td valign="top" width="20%">Nama</td><td valign="top"> : </td>
                    <td align="justify" width="80%"><?php echo $dosen ?></td>
                </tr>
                <tr>
                    <td valign="top">NIDN/NPP</td><td valign="top"> : </td>
                    <td align="justify"><?php echo $nidn ?></td>
                </tr>
                <tr>
                    <td valign="top">Judul <?php echo $jenis ?></td><td valign="top"> : </td>
