<html>
	<head>
		<title>Surat Kontrak Pengabdian kepada Masyarakat</title>
		<style>
...
NOMOR: <?php echo $tugas['nomorkontrak'];?>
		...
		<table style="margin-top:10">
			...
			<?php
				...
				{
					$angg = $this->msubmit->perananggota($tugas['id_usulan'],'Pengabdian');
					$hits = count($angg);
					$n = 0;
		...
		<p><b>PIHAK PERTAMA</b> dan <b>PIHAK KEDUA</b> secara bersama-sama bersepakat mengikatkan diri dalam suatu Perjanjian Kontrak dalam Pelaksanaan Pengabdian kepada Masyarakat dengan  ketentuan  dan   syarat-syarat yang diatur sebagai berikut:</p>
		<h3 align="center" class="no-break-after">Pasal 1<br>DASAR HUKUM</h3>
		<ol type="1">
			<li>Surat Perjanjian Kontrak Pengabdian kepada Masyarakat ini berdasarkan kepada:
			</li>
			<ol type="a">
				<?php
		...
		<ol type="1">
			...
			<ol type="a">
				<li>memberikan pendanaan Pengabdian kepada Masyarakat kepada <b>PIHAK KEDUA</b>; </li>
		...
		<ol type="1">
			...
			<li><b>PIHAK KEDUA</b> mempunyai hak mendapatkan dana Pengabdian kepada Masyarakat dari <b>PIHAK PERTAMA</b></li>
			<li class="no-break-after">Pendanaan Pengabdian kepada Masyarakat sebagaimana dimaksud pada ayat (2), dapat dibayarkan setelah <b>PIHAK KEDUA</b> mengunggah ke laman <b>simlitabmas.unjaya.ac.id</b> selambat-lambatnya bulan <b>Desember <?php echo $th;?></b> dokumen sebagai berikut:</li>
			<ol type="a">
				<li>Laporan kemajuan pelaksanaan Pengabdian kepada Masyarakat</li>
				<li>Surat pernyataan tanggungjawab belanja (SPTB) atas dana Pengabdian kepada Masyarakat yang telah ditetapkan</li>
				<li>Laporan akhir Pengabdian kepada Masyarakat.</li>
				<li>Luaran Pengabdian kepada Masyarakat</li>
			</ol>
			<li>Pendanaan Kontrak Pengabdian kepada Masyarakat sebagaimana dimaksud dalam ayat (2) dibayarkan kepada <b>PIHAK KEDUA</b>.</li>
		</ol>
		<h3 align="center" class="no-break-after">Pasal 6<br>PERGANTIAN KEANGGOTAAN</h3>
		<ol type="1">
			<li>Perubahan terhadap susunan tim pelaksana dan substansi Pengabdian kepada Masyarakat dapat dibenarkan apabila telah mendapat persetujuan dari Lembaga Penelitian dan Pengabdian kepada Masyarakat (LPPM).</li>
			<li>Apabila Ketua tim pelaksana Pengabdian kepada Masyarakat tidak dapat menyelesaikan Pengabdian kepada Masyarakat atau mengundurkan diri, maka <b>PIHAK KEDUA</b> wajib menunjuk pengganti Ketua Tim Pelaksana Pengabdian kepada Masyarakat yang merupakan salah satu anggota tim setelah mendapat persetujuan tertulis dari Lembaga Penelitian dan Pengabdian kepada Masyarakat (LPPM).</li>
			<li>Dalam hal tidak adanya pengganti ketua tim pelaksana Pengabdian kepada Masyarakat sesuai dengan syarat ketentuan yang ada, maka Pengabdian kepada Masyarakat dibatalkan dan dana dikembalikan ke Program Kerja dan Rancangan Anggaran (PKRA).</li>
		</ol>
		...
		<ol type="1">
			<li>Hak atas kekayaan Intelektual yang dihasilkan dari pelaksanaan Pengabdian kepada Masyarakat diatur dan dikelola sesuai dengan peraturan dan perundang-undangan yang berlaku;</li>
			<li>Setiap publikasi, makalah dan/atau ekspos dalam bentuk apapun yang berkaitan dengan hasil Pengabdian kepada Masyarakat ini wajib mencantumkan <b>Universitas Jenderal Achmad Yani Yogyakarta</b> sebagai pemberi dana;</li>
			<li>Hasil Pengabdian kepada Masyarakat berupa peralatan dan/atau alat yang dibeli dari kegiatan Pengabdian kepada Masyarakat ini adalah milik negara dan dapat dihibahkan kepada Program Studi melalui Berita Acara Serah Terima (BAST);</li>
		</ol>
		<h3 align="center" class="no-break-after">Pasal 9<br>KEADAAN KAHAR</h3>
		<ol type="1">
			<li><b>PARA PIHAK</b> dibebaskan dari tanggung jawab atas keterlambatan atau kegagalan dalam memenuhi kewajiban yang dimaksud dalam Kontrak Pengabdian kepada Masyarakat disebabkan atau diakibatkan oleh peristiwa atau kejadian diluar kekuasaan <b>PARA PIHAK</b> yang dapat digolongkan sebagai keadaan memaksa (force majeure) ;</li>
			<li>Peristiwa atau kejadian yang dapat digolongkan keadaan memaksa (force majeure) dalam Kontrak Pengabdian kepada Masyarakat ini adalah bencana alam, wabah penyakit, kebakaran, perang, blokade, peledakan, sabotase, revolusi, pembrontakan, huru hara, serta adanya tindakan pemerintah dalam bidang ekonomi dan moneter yang secara nyata berpengaruh terhadap pelaksanaan Kontrak Pengabdian kepada Masyarakat ini;</li>
		...
		<ol type="1">
			<li>Apabila terjadi perselisihan antara <b>PIHAK PERTAMA</b> dan <b>PIHAK KEDUA</b> dalam pelaksanaan Kontrak Pengabdian kepada Masyarakat ini akan dilakukan penyelesaian secara musyawarah dan mufakat;</li>
		...
		<p>Apabila terdapat hal-hal lain yang belum diatur dalam Kontrak Pengabdian kepada Masyarakat ini dan memerlukan perubahan, maka akan diatur kemudian oleh <b>PARA PIHAK</b> melalui amandemen Kontrak Pengabdian kepada Masyarakat dan/atau melalui Pembuatan perjanjian tersendiri yang merupakan bagian tidak terpisahkan dari Kontrak Pengabdian kepada Masyarakat ini.</p>
		<h3 align="center" class="no-break-after">Pasal 12<br>SANKSI</h3>
		<ol type="1">
			<li>Apabila sampai batas waktu yang telah ditetapkan untuk melaksanakan kontrak Pengabdian kepada Masyarakat telah berakhir, <b>PIHAK KEDUA</b> tidak melaksanakan kewajiban sebagaimana dimaksud dalam pasal 4 ayat (2), maka <b>PIHAK KEDUA</b> dikenakan sanksi administratif.</li>
			<li>Sanksi administratif sebagaimana dimaksud pada ayat (1) adalah berupa pemotongan anggaran pada Tahap Kedua yaitu hanya akan dicairkan sebesar 15% dari sisa dana yang belum dicairkan serta tidak dapat mengajukan proposal Pengabdian kepada Masyarakat sampai terselesaikannya kewajiban yang telah ditetapkan baik ketua maupun anggota.</li>
		</ol>
		<h3 align="center" class="no-break-after">Pasal 13<br>LAIN-LAIN</h3>
		<p>Dalam hal <b>PIHAK KEDUA</b> berhenti atau menggundurkan dari sebagai ketua pelaksana sebelum Kontrak Pengabdian kepada Masyarakat ini selesai, maka <b>PIHAK KEDUA</b> wajib melakukan serah terima tanggungjawabnya kepda anggota Pengabdian kepada Masyarakat yang menggantikannya.</p>
		<h3 align="center" class="no-break-after">Pasal 14<br>PENUTUP</h3>
		<p>Surat Perjanjian Kontrak Pengabdian kepada Masyarakat ini dibuat rangkap 2 (dua), dan bermaterai cukup sesuai dengan ketentuan yang berlaku dan biaya materainya dibebankan kepada <b>PIHAK KEDUA</b>.</p>
		
		<div class="no-break">
		<table style="margin-top:40">
			<tr>
				<td width="300px"><b>PIHAK PERTAMA</b><br>Ka. LPPM Unjaya</td>
