<?php
	...
	header("Content-Disposition: attachment; filename=rekap_kontrak_pengabdian_$date.xls");
?>
	<h2>Surat Kontrak Pengabdian</h2>
		...
		<?php
			...
			foreach($pengabdian as $p)
			{
				...
				echo "<td>".ucwords(strtolower($p->judul))."</td>
						  ...
						  <td>".($p->suratkontrak<>''?'Sudah Unggah':'Belum Unggah')."</td>
						</tr>";
						$no++;
			}
		?>	
