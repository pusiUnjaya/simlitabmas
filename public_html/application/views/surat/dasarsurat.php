<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dasar Hukum Surat Tugas/Kontrak</h1>
			</div>
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<div class="row">
						<div class="col-md-12">
						  <h6 id="daftarpenelitian" class="m-0 font-weight-bold text-primary">Dasar Hukum</h6>
						  <div class="col-sm-12 col-md-4 float-right" style="margin-top:-25px;margin-right: -200px;">
								  <a href="<?php echo base_url(); ?>surat/tambahdasar" type="button" class="btn btn-primary"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah</a>
							</div>
						</div>
				</div>
				</div>
