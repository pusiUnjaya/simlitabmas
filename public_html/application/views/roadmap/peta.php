<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Daftar Dokumen Roadmap</h6>
		</div>
		<div class="card-body">
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
					<thead>
						<tr>
							...
							<th>Program Studi</th>
							<th width="20%">Roadmap Prodi</th>
							<th width="20%">Roadmap Dosen</th>
						</tr>
					</thead>
					<tbody>
						<tr>
								...
								<?php
									...
									foreach($prodi as $d)
									{
										...
										if($d->prodi<>'Sistem Informasi (D-3)')
											echo '<li><a href="'.base_url().'roadmap/prodi/'.$d->id_prodi.'">'.$d->prodi.' - '.$jml.' Dosen</a></li>';
									}
									echo '</ol>';
								?>
							</td>
							<td>
								<?php
									...
									foreach($prodi as $d)
									{
										$map = $this->mroadmap->cekprodi($d->id_prodi);
										if($d->prodi<>'Sistem Informasi (D-3)'){
										if($map>0)
											echo '<li style="color:green">Sudah Upload</li>';
										else
											echo '<li>Belum Upload</li>';
										}
									}
									echo '</ol>';
								?>
							...
							<td>
								<?php
									...
									foreach($prodi as $d)
									{
										$dos = $this->mroadmap->roadmapvalid($d->id_prodi);
										$jml = $this->mroadmap->jumlahdosen($d->id_prodi);
										$sisa = $jml - $dos;
										if($d->prodi<>'Sistem Informasi (D-3)')
