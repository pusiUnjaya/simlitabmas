<div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form class="user" action="<?php echo base_url(); ?>dosen/simpan" method="post">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <label>Nama Lengkap</label>
					<input type="text" name="namalengkap" class="form-control" placeholder="Nama Lengkap dengan Gelar" required>
                  </div>
                  <div class="col-sm-6">
				...
				<div class="form-group row">
                  ...
                  <div class="col-sm-6">
					...
					<input type="text" name="tglahir" id="tglahir" class="form-control" placeholder="Tanggal Lahir" required>
                  </div>
                </div>
				<div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <div class="col-sm-6">
					...
					<input type="text" name="nidn" class="form-control" placeholder="NPP/NIDN" required>
                  </div>
                </div>
				<div class="form-group row">
                  <div class="col-sm-6">
                ...
                <div class="form-group row">
                  <div class="col-sm-6">
					...
					<input type="text" name="alamat" class="form-control" id="exampleAlamat" placeholder="Alamat Rumah" required>
                  </div>
				  <div class="col-sm-6 mb-3 mb-sm-0">
				...
				<div class="form-group row">
                  <div class="col-sm-6">
					...
					<input type="text" name="web" class="form-control" id="exampleAlamat" placeholder="Website Pribadi">
                  </div>
				  <div class="col-sm-6 mb-3 mb-sm-0">
				...
				<div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
					...
					<input type="text" name="google" class="form-control" placeholder="ID Google Scholar">
                  </div>
                  <div class="col-sm-6">
                    <label>ID Scopus</label>
					<input type="text" name="scopus" class="form-control" placeholder="ID Scopus">
                  </div>
                </div>
				<div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <label>ID Sinta</label>
					<input type="text" name="sinta" class="form-control" placeholder="ID Sinta">
                  </div>
                </div>
