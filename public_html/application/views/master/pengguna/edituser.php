<div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Edit Form Pengguna</h6>
            </div>
            <div class="card-body">
            	<div id="hitung"></div>
              <form class="user" action="<?php echo base_url(); ?>pengguna/update" method="post">
                <div class="form-group">
                	<label>Alamat Email</label>
                  <input type="email" name="email" class="form-control" id="username" placeholder="Alamat Email" value="<?php echo $pengguna['email'] ?>" required>
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-6 mb-3 mb-sm-0">
					...
					<select name="prodi" id="prodi" class="form-control">
						<?php
							$namaprodi = $this->mdosen->namaprodi($pengguna['prodi']);
							echo '<option value="'.$pengguna['prodi'].'">'.$namaprodi['prodi'].'</option>';
						?>
					</select>
                  </div>
                </div>
				<div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <select name="jenis" class="form-control">
						<?php
							...
							for($i=0;$i<$n;$i++)
							{
								if($pengguna['jenis']==($n-$i))
								echo '<option value="'.($n-$i).'" selected>'.$jenis[$i].'</option>';
								else
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                          <div class="col-sm-11">
                            <input type="password" name="password" id="pass" class="select2-single-placeholder form-control mb-3" placeholder="Minimal 8 karakter (huruf kapital,huruf kecil,angka,simbol)">
                          </div>
				...
				<div class="col-sm-12 d-sm-flex align-items-center justify-content-between mb-4">
					...
					<input type="submit" value="Update" id="tombol" class="d-sm-inline-block col-sm-5 btn btn-primary btn-user btn-block">
				</div>
