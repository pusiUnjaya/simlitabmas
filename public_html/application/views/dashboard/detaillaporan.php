...
<div class="container-fluid">
          ...
          <div class="row">
                  ...
                  <div class="pt-2 pb-2">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							echo '</p><p>';
							if($bukaan['status']==1) {
							if($hitlapreview>0 && $revisilaporan>0) { ?>
            ...
            <?php if($this->session->userdata('sesi_status')==1 || ($laporan['reviewer']<>'' && $laporan['pengusul'] <> $this->session->userdata('sesi_id'))) { echo '</div></div>'; } ?>
            </div>
		...
		<div class="row">
          <div class="form-group col-md-6">
				...
				<select name="jenispublikasi" id="selectjenis" class="form-control jurnal3">
					<?php
						$jenis = array('Jurnal Nasional BerISSN','Jurnal Nasional Terakreditasi 3-6','Jurnal Nasional Terakreditasi 1-2','Jurnal Internasional','Jurnal Internasional Bereputasi');
						$n = count($jenis);
						for($i=0;$i<$n;$i++)
						{
        ...
        <table class="table table-bordered">
			  <thead>
				<tr>
				  ...
				  <th scope="col"  width="14%">Skor (1-7)</th>
