...
<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Submit Naskah Akademik/Urgensi</h1>
          </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Submit Naskah Akademik/Urgensi</h6>
            </div>
            <div class="card-body">
              <form id="tambahjurnal" method="post" action="<?php echo base_url().'dashboard/simpannaskah'; ?>" enctype="multipart/form-data">
		<div class="row">
          <div class="form-group col-md-6">
				<input type="hidden" id="id_naskah" name="id">
				...
				<label>Judul Naskah</label><span id="judul_status" style="float:right;color:red"></span>
				<textarea name="judul" onkeyup="cekjudul();" class="form-control naskah3" id="judulnaskah" placeholder="Judul Naskah" required></textarea>
			...
			<div class='form-group col-md-5'>
				...
				<input type="text" name="tgl" id="tglserah" class="form-control naskah6" placeholder="Tanggal Penyerahan" required>
				<label>Pejabat Penerima Naskah</label>
				<input type="text" name="pejabat" class="form-control naskah7" placeholder="Pejabat Penerima Naskah" required>
				<label>URL</label>
				<input type="text" name="url" class="form-control naskah8" placeholder="http:// (bila ada)">
				<label>File Naskah (PDF) maksimal 20MB</label>
				<input type="file" name="fileupload" class="form-control unggah" placeholder="File Naskah (PDF)" required>
				<label for="recipient-name" class="col-form-label">File Naskah : 
			<b class="naskah9"></b></label>
		  </div>
      </div>
      </div>
...
<script>
	...
	function cekjudul()
	{
		var judul=document.getElementById( "judulnaskah" ).value;
			
		if(judul)
		{
			$.ajax({
				type: 'post',
				url: "<?php echo base_url('dashboard/cekjudulnaskah');?>",
				data: {
					judul_naskah:judul,
				},
