...
<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Submit Penelitian Tambahan</h1>
          </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Submit Penelitian Tambahan</h6>
            </div>
            <div class="card-body">
              <form method="post" action="<?php echo base_url().'dashboard/simpanpenelitian'; ?>" enctype="multipart/form-data">
		<div class="row">
          <div class="form-group col-md-6">
				<input type="hidden" id="id_penelitian" name="id">
				<label>Judul Penelitian</label>
				<textarea name="judul" id="judulpenelitian" class="form-control teliti1" placeholder="Judul Penelitian" required></textarea>
				<label>Tahun Penelitian</label>
				<input type="text" name="tahun" class="form-control teliti2" placeholder="Tahun Penelitian" required>
				...
				<input type="text" name="bidang" class="form-control teliti4" placeholder="Bidang Penelitian" required>
				<label>Tujuan Sosial Ekonomi</label>
				<textarea name="tujuan" class="form-control teliti5" placeholder="Tujuan Sosial Ekonomi" required></textarea>
				<label for="recipient-name" class="col-form-label">Sumber Dana</label><br>
				<div class="form-check form-check-inline">
				  <input class="form-check-input" type="radio" name="sumber" value="Dalam Negeri">
				  <label class="form-check-label">Dalam Negeri</label>
				</div>
				<div class="form-check form-check-inline">
				  <input class="form-check-input" type="radio" name="sumber" value="Luar Negeri/Asing">
