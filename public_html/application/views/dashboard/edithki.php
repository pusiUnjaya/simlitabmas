...
<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit HKI</h1>
          </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Edit HKI</h6>
            </div>
            <div class="card-body">
              <form id="tambahjurnal" method="post" action="<?php echo base_url().'dashboard/simpanhki'; ?>" enctype="multipart/form-data">
		<div class="row">
          <div class="form-group col-md-6">
				<input type="hidden" id="idusulan_hki" value="<?php echo $tambahan['id_hki'];?>" name="id">
				<label>Judul HKI</label>
				<textarea name="judul" class="form-control hki1" placeholder="Judul HKI" required><?php echo ucwords(strtolower($tambahan['judul']));?></textarea>
				...
				<select name="tahunpelaksanaan" id="selecttahunhki" class="form-control hki3">
					<?php
						...
						for($i=0;$i<=15;$i++)
						{
							if($tambahan['tahun_pelaksanaan']==($tahun-$i))
				...
				<input type="text" name="nomordaftar" value="<?php echo $tambahan['nomor_pendaftaran'];?>" class="form-control hki4" placeholder="Nomor Pendaftaran" required>
				</div>
				<div class="form-group col-md-6">
				...
				<input type="text" name="authorlain" id="authorlain" class="form-control" placeholder="Author Lain Biarkan Kosong jika Tidak Ada Perubahan">
					...
					<input type="hidden" name="iddosen" id="values" value="<?php echo $tambahan['authorlain'];?>">
				...
				<input type="text" name="nomorhki" value="<?php echo $tambahan['nomor_hki'];?>" class="form-control hki6" placeholder="Nomor HKI" required>
				<label>URL HKI</label>
				<input type="text" name="url" value="<?php echo $tambahan['url_dokumen'];?>" class="form-control hki7" placeholder="http://">
			...
			<b class="hki8"><?php echo $tambahan['file_hki']; ?></b></label>
		  </div>
      </div>
      </div>
