...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body" style="padding:0px !important;background-color:#eee !important;">
					...
					<div class="card-body pd-10">
						<div class="form-group row">
							<div class="col-sm-6">
								...
								<p><a href="<?php echo base_url('assets/uploadbox/' . $usulan['fileusulan']); ?>" target="_blank"><?php echo $usulan['fileusulan']; ?></a></p>
							</div>
							<div class="col-sm-6 mb-3 mb-sm-0">
								<?php
								if ($this->session->userdata('sesi_status') == 1) {
...
<script>
	...
	$(document).ready(function() {
		...
		function load_anggota_dosen() {
			$.ajax({
				url: "<?php echo site_url('submit/load_anggota_dosen/' . $this->uri->segment(3)); ?>",
				method: "POST",
				success: function(data) {
					hsl = data;
				},
		...
		function load_anggota_mhs() {
			$.ajax({
				url: "<?php echo site_url('submit/load_anggota_mhs/' . $this->uri->segment(3)); ?>",
				method: "POST",
				success: function(data) {
					hsl = data;
				},
