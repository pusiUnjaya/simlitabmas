  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	  ...
	  <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse <?php if($this->uri->segment(1)=='pengguna' || $this->uri->segment(1)=='dosen' || $this->uri->segment(1)=='reviewer' || $this->uri->segment(1)=='kuesioner' || $this->uri->segment(1)=='dokumen') echo $show; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          ...
          <span>Pengguna</span></a>
            <a class="collapse-item <?php if($this->uri->segment(1)=='dosen') echo $active; ?>" href="<?php echo base_url(); ?>dosen">
	  ...
	  <li class="nav-item">
        ...
        <div id="collapseRekap" class="collapse <?php if($this->uri->segment(1)=='rekap' && ($this->uri->segment(2)=='' || $this->uri->segment(2)=='jurnal' || $this->uri->segment(2)=='penelitian' || $this->uri->segment(2)=='pengabdian' || $this->uri->segment(2)=='jurnal' || $this->uri->segment(2)=='hki' || $this->uri->segment(2)=='prosiding' || $this->uri->segment(2)=='buku' || $this->uri->segment(2)=='karya' || $this->uri->segment(2)=='naskah')) echo $show; ?>" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
				<?php if($this->session->userdata('sesi_status')<>1 && $this->session->userdata('sesi_nama')<>'') { ?>
