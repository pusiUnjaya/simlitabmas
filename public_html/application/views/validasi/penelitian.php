<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Validasi Kinerja Dosen - Penelitian</h1>
						...
						<?php
							...
							if($hitplus>0)
							{
								foreach($tambahan as $p)
								{
									...
									<br><b>Tahun : </b>".$p->tahun." | <b>Ketua :</b>".$namaketua." | <b>Sumber Dana :</b> 
									".$p->sumberdana."
									...
									echo "</td>
									<td><a href='".base_url()."validasi/detailpenelitian/".$p->id_penelitian."' type='button' class='btn btn-success'>validasi</a></td>
									</tr>";
									$no++;
