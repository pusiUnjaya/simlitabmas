...
<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Detail Penelitian Tambahan</h1>
          </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Detail Penelitian Tambahan</h6>
            </div>
            <div class="card-body">
              <form method="post" action="<?php echo base_url().'validasi/updatepenelitian/'.$this->uri->segment(3); ?>" enctype="multipart/form-data">
		<div class="row">
          <div class="form-group col-md-6">
				...
				<br><label>Jenis Penelitian :</label>
				<label style="color:black"><?php echo $tambahan['jenis']; ?></label>
				<br><label>Bidang Penelitian : </label>
				<label style="color:black"><?php echo $tambahan['bidang']; ?></label>
				<br><label>Tujuan Sosial Ekonomi : </label>
				<label style="color:black"><?php echo $tambahan['tujuan']; ?></label>
			...
			<div class='form-group col-md-6'>
				...
				<label style="color:black"><?php echo $tambahan['institusi']; ?></label>
				<label>Jumlah Dana : </label>
				<label style="color:black"><?php echo rupiah($tambahan['dana'],2); ?></label>
				<br><label>Ketua Peneliti : </label>
				<?php
					$namauthor = '';
				...
				echo '<label style="color:black">'.$namauthor.'</label>'; ?>
				<label>File Laporan Penelitian Akhir (PDF) : </label>
				<label style="color:black"><a href="<?php echo base_url().'assets/uploadbox/'.$tambahan['file_laporan_akhir']; ?>">download di sini</b></a></label>
	  ...
	  <div class="modal-footer">
		<a href="<?php echo base_url().'validasi/penelitian'; ?>" type="button" class="btn btn-secondary">Batal</a>
