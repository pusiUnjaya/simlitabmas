...
<div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Upload Proposal Pengabdian</h6>
            </div>
            <div class="card-body">
              <form class="user" action="<?php echo base_url(); ?>klinik/simpanpkm" method="post" enctype="multipart/form-data">
			  <input type="hidden" name="jenis" class="form-control" value="Pengabdian">
                <div class="form-group">
				  <label>Judul Pengabdian</label>
                  <input type="text" name="judul" class="form-control" placeholder="Masukkan Judul Pengabdian" required>
                </div>
				<div class="form-group row">
                  <div class="col-sm-6">
                    <label>Anggota Pengabdi(Maks 2 Anggota)</label>
                    <input type="text" name="anggotadosen" id="anggotadosen" class="form-control">
				...
				<div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="text" name="rab" id="jmldana" class="form-control" placeholder="Masukkan Total RAB" required>
                  </div>
                  <div class="col-sm-6">
					<label>File Proposal</label>
                    <input type="file" name="proposal" class="form-control unggah" placeholder="Masukkan File Proposal" required>
                  </div>
                </div>
