<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Daftar Dokumen Klinik Proposal Pengabdian</h6>
		</div>
		<div class="card-body">
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
					...
					<tbody>
						<tr>
							...
							<td>
								<?php
									$prodi = $this->mklinik->prodi(2);
									echo '<ol>';
									foreach($prodi as $d)
									{
										$jml = $this->mklinik->jumlahdosen($d->id_prodi);
										if($d->prodi<>'Sistem Informasi (D-3)')
											echo '<li><a href="'.base_url().'klinik/prodi/'.$d->id_prodi.'/pkm">'.$d->prodi.' - '.$jml.' Dosen</a></li>';
									}
									echo '</ol>';
								?>
							</td>
							<td>
								<?php
									...
									foreach($prodi as $d)
									{
										$dos = $this->mklinik->cekdosenpkm($d->id_prodi);
										$jml = $this->mklinik->jumlahdosen($d->id_prodi);
										$sisa = $jml - $dos;
										if($d->prodi<>'Sistem Informasi (D-3)')
											echo '<li>'.$dos.' sudah '.$sisa.' belum</li>';
									}
									echo '</ol>';
								?>
							</td>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Upload Dokumen klinik</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form method="post" action="<?php echo base_url().'klinik/simpan'; ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo base_url().'klinik/update'; ?>" enctype="multipart/form-data">
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">Judul</label>
						<div class="col-sm-10">
