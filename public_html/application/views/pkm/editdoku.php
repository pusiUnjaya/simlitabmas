					...
					<div class="col-sm-6 mb-3 mb-sm-0">
						...
						?>
							...
							<select name="statususulan" class="form-control">
								<?php
								$jenis = array('Usulan Baru', 'Usulan Dikirim', 'Usulan Disetujui Prodi', 'Reviewed', 'Usulan Disetujui Reviewer', 'Usulan Tidak Disetujui Reviewer', 'Usulan Disetujui', 'Usulan Tidak Disetujui');
								$n = count($jenis);
								for ($i = 0; $i < $n; $i++) {
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<label for="recipient-name" class="col-form-label">Tugas Dalam Pengabdian * :</label>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form-tambah-dosenluar">
					...
					<div class="form-group row-fluid">
						<label for="dosenluar-tugas-master" class="col-form-label">Tugas Dalam Pengabdian * :</label>
