            ...
            <div class="col-sm-12">
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-2 mb-3 mb-sm-0">
					...
					<input name="jumlahmhs" id="jumlahmhs" type="number" value="<?php echo $usulan['jumlahmhs'];?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" placeholder="Jml Mahasiswa" required>
                  </div>
