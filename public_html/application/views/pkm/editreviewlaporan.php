...
<div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Review Laporan Akhir PkM</h1>
          </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Edit Review Laporan Akhir PkM</h6>
            </div>
            <div class="card-body">
              <form class="user" method="post" action="<?php echo base_url().'pengabdian/updatereviewlaporan/'.$this->uri->segment(3); ?>" enctype="multipart/form-data">
				  ...
				  <table class="table table-bordered">
					  ...
					  <?php 
							...
							if($review['skor']<>'' && $skor[0]<>'' && $hitskor>0)
							{
								...
								$poin3 = $skor[2];
								$poin4 = $skor[3];
								$thn = date('Y', strtotime($review['modified']));
								if($thn>=2023)
									$final = (($skor[0]*30)+($skor[1]*30)+($skor[2]*20)+($skor[3]*20))/4;
								else
									$final = (($skor[0]*30)+($skor[1]*30)+($skor[2]*20)+($skor[3]*20))/7;
							}
							else
							{
								$poin1 = 0;
					  ...
					  <tbody>
						<tr>
						  ...
						  <td><input type="text" name="poinsatu" data-poin="30" onkeyup="satu(value)" value="<?php echo $poin1; ?>" class="form-control rev" required></td>
						  <td><b id="nilai1"><?php echo $poin1*30; ?></b></td>
						</tr>
						<tr>
						  <td>2</td>
						  <td>
						  ...
						  <td><input type="text" name="poindua" data-poin="30" onkeyup="dua(value)" class="form-control rev" value="<?php echo $poin2; ?>" required></td>
						  <td><b id="nilai2"><?php echo $poin2*30; ?></b></td>
						</tr>
						<tr>
						  <td>3</td>
						  <td>
						...
						<tr>
						  ...
						  <td><input type="text" name="poinempat" data-poin="20" onkeyup="empat(value)" value="<?php echo $poin4; ?>" class="form-control rev" required></td>
						  <td><b id="nilai4"><?php echo $poin4*20; ?></b></td>
						</tr>
						<tr>
