						...
						<!--<div class="row">
							...
							<div class="col-md-8">
								<?php //if($usulan['legalisir']<>'') { ?>
									<p><?php //echo '<a href="'.base_url().'assets/uploadbox/'.$usulan['legalisir'].'" data-toggle="modal" data-target="#liatlegal">Download File Legalisir</a>'; ?></p>
									<a href="" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-legaldoc="" data-usulan="<?php //echo $this->uri->segment(3);?>" data-toggle="modal" data-target="#legalisir-modal"><i class="fas fa-sticky-note fa-sm text-white-50"></i> Update Legalisir</a>
									<?php //}
							...
							<td>
								...
								<table class="table table-bordered">
									<tr><th>Skor</th><th>Keterangan</th></tr>
										<tr><td>1</td><td>Latar belakang masalah yang diuraikan tidak menggambarkan analisis situasi yang ada pada lokasi pengabdian</td></tr>
										<tr><td>2</td><td>Latar belakang masalah yang diuraikan kurang menggambarkan analisis situasi yang ada pada lokasi pengabdian</td></tr>
										<tr><td>3</td><td>Latar belakang masalah yang diuraikan cukup menggambarkan analisis situasi yang ada pada lokasi pengabdian</td></tr>
										<tr><td>4</td><td>Latar belakang masalah yang diuraikan sudah menggambarkan analisis situasi yang ada pada lokasi pengabdian.</td></tr>
								</table>
							</td>
							<td><b>20</b></td>
